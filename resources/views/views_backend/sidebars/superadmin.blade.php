...
<aside id="sidebar" class="sidebar overflow-y-auto overflow-x-hidden">
  <div class="logo-area">
    <a href="{{ route('superadmin.dashboard') }}" class="d-inline-flex">
  ...
  <ul class="nav flex-column">
    ...
    <li><a class="nav-link @if(request()->routeIs('superadmin.dashboard')) active @endif"
        href="{{ route('superadmin.dashboard') }}"><i class="ti ti-home"></i><span class="nav-text">Dashboard</span></a>
    </li>
    <li><a class="nav-link @if(request()->routeIs('superadmin.event-list')) active @endif"
        href="{{ route('superadmin.event-list') }}"><i class="ti ti-box-seam"></i><span class="nav-text">Event
          List</span></a></li>
    ...
    <li><a class="nav-link @if(request()->routeIs('superadmin.create-event')) active @endif"
        href="{{ route('superadmin.create-event') }}"><i class="ti ti-plus"></i><span class="nav-text">Add Event</span></a>
    </li>
    ...
    <li><a class="nav-link @if(request()->routeIs('superadmin.user-roles')) active @endif"
        href="{{ route('superadmin.user-roles') }}"><i class="ti ti-user-screen"></i><span class="nav-text">User
          Roles</span></a></li>
