				...
				<div class="header-top">
					<div class="row">
						<div class="col-md-6">
							<div class="full">
								<div class="logo">
									<a href="{{ route('home') }}"><img style="width: 30%;" src="{{ asset('images/logo.png') }}" alt="#" /></a>
								</div>
							</div>
						</div>
						<div class="col-md-6">
								...
								<ul class="login">
									...
									<li>
										<div class="cart-option">
											<a href="{{ route("auth.signup") }}"><i class="fa fa-shopping-cart"></i>Register</a>
										</div>
									</li>
								</ul>
								<!-- end button section -->
																	...
																	<div id="menCollection" class="carousel slide" data-ride="carousel">
																		<div class="carousel-inner">
																			<div class="item active">
																				<div class="banner-for-match"><a href="#"><img class="img-responsive" src="{{ asset('images/match-banner1.jpg') }}" alt="#" /></a></div>
																			</div>
																			<!-- End Item -->
																			<div class="item">
																				<div class="banner-for-match"><a href="#"><img class="img-responsive" src="{{ asset('images/match-banner1.jpg') }}" alt="#" /></a></div>
