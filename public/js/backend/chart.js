// ApexCharts is loaded from CDN in the layout
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.getElementById("salesChart")) {
        ...
        const salesThisYear = [
            42000, 53000, 48000, 61000, 72000, 69000, 74000, 82000, 78000,
            86000, 91000, 97000,
        ];
        const salesLastYear = [
            38000, 45000, 47000, 56000, 65000, 63000, 68000, 70000, 69000,
            75000, 80000, 84000,
        ];
        ...
        function updateMonthlySales(currentYearArray, compareYearArray = null) {
            if (
                !Array.isArray(currentYearArray) ||
                currentYearArray.length !== 12
            ) {
                console.warn(
            ...
            if (
                Array.isArray(compareYearArray) &&
                compareYearArray.length === 12
            ) {
